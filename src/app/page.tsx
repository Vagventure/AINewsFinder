...
export default function Home() {
  ...
  return (
    <div className="min-w-[97vw] h-auto bg-gray-700 ">
      <Navbar/>
      <div className="min-w-[97vw] flex justify-center">
        ...
        {news && <div className="News-section w-full min-h-screen p-2 mb-24 space-y-5">
          {news.map(e=>{
            ...
            <div onClick={()=>infoClick(e)} className="w-[70%] h-full flex flex-col justify-evenly">
